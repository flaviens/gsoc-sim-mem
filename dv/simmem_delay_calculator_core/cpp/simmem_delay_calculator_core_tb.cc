...
// //   // Stores the next local identifier that will be releasable, along with
// its
// //   // expiration time
...
// //   for (size_t current_time = 0; current_time < nb_iterations;
// current_time++)
// //   {
// //     if (kIterationVerbose) {
...
// //     // where multiple local identifiers are simultaneously newly
// releasable
// //     while (next_id_and_expiration.second == current_time) {
// //       if (kTransactionVerbose) {
// //         std::cout << "Delay expired for id " <<
// next_id_and_expiration.first
...
// //       // Determine the next identifier whose actual release will be
// signaled
// //       to
// //       // the DUT instance
// //       do {
